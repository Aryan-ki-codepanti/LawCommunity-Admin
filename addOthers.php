...
<div class="container ps-5  py-5 login-container">
    ...
    <div class="course-form">
        <form enctype="multipart/form-data" method="POST" action="addOthers.php">

            <!-- General intro -->
            <div class="course-box course-title">
                <h3 class="text-center"> Others - General section </h3>
            ...
            <div class="d-flex justify-content-center gap-4">
                    <input name="submit" type="submit" value="Add to Others" class="btn btn-lg btn-primary">
            </div>
        </form>
    </div>
...
<?php
    ...
    if (isset($_POST["submit"])){
        ...
        if (!$insertion){
            echo "<script> alert('Other Failed $conn->error') </script>" ;
        }
        else{
            echo "<script> alert('Other added Successfully ') </script>" ;
        }
