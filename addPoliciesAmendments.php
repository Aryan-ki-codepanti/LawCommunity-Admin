...
<div class="container ps-5  py-5 login-container">
    ...
    <h3> Adding Policy/Amendment </h3>

    <div class="course-form">
        <form enctype="multipart/form-data" method="POST" action="addPoliciesAmendments.php">

            <!-- General intro -->
            <div class="course-box course-title">
                <h3 class="text-center"> Policy/Amendment - General section </h3>
            ...
            <div class="d-flex justify-content-center gap-4">
                    <input name="submit" type="submit" value="Add to Policy / Amendment" class="btn btn-lg btn-primary">
            </div>
        </form>
    </div>
...
<?php
    ...
    if (isset($_POST["submit"])){
        ...
        $table_name = "policies_amendments";
        ...
        if (!$insertion){
            echo "<script> alert('Policy / Amendment Failed $conn->error') </script>" ;
        }
        else{
            echo "<script> alert('Policy / Amendment added Successfully ') </script>" ;
        }
